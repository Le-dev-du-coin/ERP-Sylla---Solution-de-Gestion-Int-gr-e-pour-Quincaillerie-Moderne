...
ALLOWED_HOSTS = ["erpsyllamadjou.com", "187.127.224.5", "localhost", "127.0.0.1"]

# https://docs.djangoproject.com/en/dev/ref/settings/#csrf-trusted-origins
CSRF_TRUSTED_ORIGINS = env.list(
    "DJANGO_CSRF_TRUSTED_ORIGINS",
    default=["https://erpsyllamadjou.com", "https://www.erpsyllamadjou.com"]
)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="ERP Ets Sylla Madjou <noreply@erp-sylla.com>",
)
...
EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend" # Par défaut dans la console pour éviter les erreurs
ANYMAIL = {
