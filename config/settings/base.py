...
MIGRATION_MODULES = {"sites": "erp_sylla.contrib.sites.migrations"}
...
MIDDLEWARE = [
    "erp_sylla.apps.core.middleware.ProxyIPMiddleware",
...
# ------------------------------------------------------------------------------
# Django Admin URL.
ADMIN_URL = "erp-sylla-admin/"
# https://docs.djangoproject.com/en/dev/ref/settings/#admins
ADMINS = ['"MaliandevBoy" <ledevducoin223@gmail.com>']
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "erp_sylla.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "erp_sylla.users.forms.UserSignupForm"}
